...
const governanceComponent = `'use client';
...
fs.writeFileSync('src/components/data-governance.tsx', governanceComponent);
console.log('Component created');

// Add tab to manage-users page
let page = fs.readFileSync('src/app/dashboard/manage-users/page.tsx', 'utf8');
page = page.replace(
...
fs.writeFileSync('src/app/dashboard/manage-users/page.tsx', page);
