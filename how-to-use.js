...
const steps = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Click "Acknowledge" to unmask the customer\'s full contact details',
      'You will see their name, company, phone number and email address',
      'Contact the customer directly or use the platform\'s negotiation tools',
    ],
...
fs.mkdirSync('src/app/how-to-use', { recursive: true });
fs.writeFileSync('src/app/how-to-use/page.tsx', page);
