...
fs.writeFileSync('src/app/api/send-receipt/route.ts', apiContent);
console.log('Receipt API created!');

// Update payment-requests.tsx to send receipt on confirmation
...
console.log('Payment requests updated!');
