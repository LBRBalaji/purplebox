...
import { ShieldCheck, Star, Truck, AlertTriangle } from 'lucide-react';
        ...
        <ScrollArea className="max-h-[60vh] px-6">
            <div className="space-y-4 text-sm pb-4">
                ...
                <div className="flex items-start space-x-3 pt-4 p-2">
                    <Checkbox id="terms-ack" checked={isChecked} onCheckedChange={(checked) => setIsChecked(checked as boolean)} className="mt-1" />
