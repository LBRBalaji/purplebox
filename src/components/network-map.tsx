...
const mapStyles: google.maps.MapTypeStyle[] = [
    ...
    { elementType: "labels.text.stroke", stylers: [{ color: "#1e3a5f" }] },
    ...
    { featureType: "landscape.natural", elementType: "geometry", stylers: [{ color: "#1e3a5f" }] },
    ...
    { featureType: "transit", elementType: "labels.text.fill", stylers: [{ color: "#1e3a5f" }] },
