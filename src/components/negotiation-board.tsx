    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            const drawPageHeader = () => {
                ...
                pdf.setFontSize(7);
                pdf.text('Lakshmi Balaji Realty · lease.orsone.app', mL, 18);
            };
            ...
            for (let p = 1; p <= totalPages; p++) {
                ...
                pdf.text('Lakshmi Balaji Realty  ·  lease.orsone.app  ·  Building Transaction Ready Assets', pageW / 2, pageH - 4, { align: 'center' });
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 no-print" style={{background:'rgba(30,21,55,0.7)'}}>
                <div className="w-full max-w-2xl max-h-screen overflow-y-auto" style={{background:'#fff',boxShadow:'0 8px 40px rgba(97,65,172,0.2)'}}>
                  ...
                  <div className="p-6 space-y-5 text-sm" style={{color:'#1e1537',lineHeight:1.8}}>
                    ...
                    <p><strong>This Memorandum of Understanding ("MoU")</strong> is entered into between the parties as identified in Transaction ID <strong>{lead.id}</strong> managed on the ORS-ONE platform (lease.orsone.app), operated by Lakshmi Balaji Realty.</p>
                    <div>
                    ...
                    <div>
                      ...
                      <p>This transaction is facilitated by ORS-ONE, a platform operated by Lakshmi Balaji Realty. ORS-ONE is not a party to the lease agreement and assumes no liability for the terms agreed between the parties.</p>
                    </div>
                    ...
                    <p className="text-xs text-center pt-4" style={{color:'#aaa',borderTop:'1px solid hsl(259 30% 90%)'}}>
                      Generated on ORS-ONE · lease.orsone.app · Lakshmi Balaji Realty · Transaction ID: {lead.id}
                    </p>
                  </div>
                </div>
              </div>
