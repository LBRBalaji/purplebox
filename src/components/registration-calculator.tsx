                    ...
                    <Card>
                         ...
                         <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <FormField control={form.control} name="stampDutyPercentage" render={({ field }) => (<FormItem><FormLabel>Stamp Duty</FormLabel><div className="flex items-center"><FormControl><Input type="number" {...field} placeholder="e.g. 5" /><span className="p-2 text-muted-foreground"><Percent className="h-4 w-4"/></span></FormControl></div><FormMessage /></FormItem>)} />
                                <FormField control={form.control} name="registrationCharges" render={({ field }) => (<FormItem><FormLabel>Registration Charges</FormLabel><div className="flex items-center"><FormControl><Input type="number" {...field} placeholder="e.g. 10000" /><span className="p-2 text-muted-foreground"><DollarSign className="h-4 w-4"/></span></FormControl></div><FormMessage /></FormItem>)} />
                            </div>
                            <Separator />
