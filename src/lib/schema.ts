...
export const commercialTermsSchema = z.object({
    siteInfo: z.object({
        ...
        googleCoordinates: z.string().optional(),
    ...
    area: z.object({
        ...
        mezzanineArea2: asOptionalField(z.coerce.number()),
        canopyArea: asOptionalField(z.coerce.number()),
        driversRestRoom: asOptionalField(z.coerce.number()),
        totalChargeableArea: asOptionalField(z.coerce.number()),
    }),
    tenantImprovements: z.object({
        electricityPower: z.string().optional(),
        internalCabling: z.string().optional(),
        hvac: z.string().optional(),
        mechanisedAccess: z.string().optional(),
        washroomsOnMezzanine: z.string().optional(),
        ramp: z.string().optional(),
        customItems: z.array(z.object({ value: z.string() })).optional(),
    }),
    leaseTerms: z.object({
        leaseTenure: z.string().optional(),
        leaseLockIn: z.string().optional(),
        fitoutHandoverDate: z.string().optional(),
        fullHandoverDate: z.string().optional(),
        rentFreePeriod: z.string().optional(),
        chargeableArea: asOptionalField(z.coerce.number()),
        leaseCommencementDate: z.string().optional(),
        rentCommencementDate: z.string().optional(),
        scopeAndCostOfRegistration: z.string().optional(),
        customItems: z.array(z.object({ value: z.string() })).optional(),
    }),
    commercialTerms: z.object({
        chargeableArea: asOptionalField(z.coerce.number()),
        buildingRentPerSft: asOptionalField(z.coerce.number()),
        totalRentPerMonth: asOptionalField(z.coerce.number()),
        capexItems: z.array(z.object({ value: z.string() })).optional(),
        netTotalRental: asOptionalField(z.coerce.number()),
        camCharges: asOptionalField(z.coerce.number()),
        ifrsd: asOptionalField(z.coerce.number()),
        rentEscalation: z.string().optional(),
        commitmentPhase2: z.string().optional(),
        additionalCharges: z.string().optional(),
    }),
    electricalInfrastructure: z.object({
        installedCapacity: z.string().optional(),
        powerRequirementP1: z.string().optional(),
        powerRequirementP2: z.string().optional(),
        scopeOfProvidingPower: z.string().optional(),
        timeToProvidePower: z.string().optional(),
        budgetForPowerP1: z.string().optional(),
        budgetForPowerP2: z.string().optional(),
        powerEnhancement: z.string().optional(),
        mainCableCapacity: z.string().optional(),
        mainPowerTappingPoint: z.string().optional(),
        internalCabling: z.string().optional(),
        internalSwitches: z.string().optional(),
        streetLightToWarehouse: z.string().optional(),
        streetLightInCompound: z.string().optional(),
        gensetRequirement: z.string().optional(),
        gensetCapacity: z.string().optional(),
        gensetProvision: z.string().optional(),
        hvacRequirement: z.string().optional(),
        hvacCapacity: z.string().optional(),
        hvacProvision: z.string().optional(),
        falseCeiling: z.string().optional(),
    }),
    building: z.object({
        buildingType: z.string().optional(),
        shopFloorDimension: z.string().optional(),
        mezzanineDimension: z.string().optional(),
        docksAndShutters: asOptionalField(z.coerce.number()),
        canopyDimension: z.string().optional(),
        naturalLighting: z.string().optional(),
        roofInsulation: z.string().optional(),
        internalLighting: z.string().optional(),
    }),
    waterAndSafety: z.object({
        workersToilet: z.string().optional(),
        executiveToilet: z.string().optional(),
        waterForWash: z.string().optional(),
        waterSource: z.string().optional(),
        overheadTank: z.string().optional(),
        waterSump: z.string().optional(),
        septicTank: z.string().optional(),
        stp: z.string().optional(),
        solidWasteDisposal: z.string().optional(),
    }),
    safetyAndSecurity: z.object({
        fireExit: z.string().optional(),
        fireHydrantOutside: z.string().optional(),
        fireHydrantInside: z.string().optional(),
        fireSprinklers: z.string().optional(),
        dedicatedWaterSump: z.string().optional(),
        fullyCompounded: z.string().optional(),
        securityAtGate: z.string().optional(),
        cctv: z.string().optional(),
        securityDesk: z.string().optional(),
    }),
});
