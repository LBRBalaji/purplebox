      ...
      <Card className="w-full max-w-md">
        ...
        <form onSubmit={handleSignup}>
          <CardContent className="space-y-4">
            ...
            {/* GST/PAN — Developer with personal email only */}
            {formData.role === 'Warehouse Developer' && isPersonalEmailAddr(formData.email) && (
              <div className="space-y-3 rounded-xl p-4 border" style={{background:'hsl(259 44% 97%)', borderColor:'hsl(259 44% 88%)'}}>
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider" style={{color:'#6141ac'}}>Business Identity Verification</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Personal email detected — GST or PAN is mandatory to verify your business identity.</p>
                </div>
                <div className="space-y-2">
            ...
            {formData.role === 'User' && isPersonalEmailAddr(formData.email) && (
              <div className="space-y-3 rounded-xl p-4 border" style={{background:'hsl(259 44% 97%)', borderColor:'hsl(259 44% 88%)'}}>
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider" style={{color:'#6141ac'}}>Identity Verification <span className="text-xs font-normal normal-case text-muted-foreground">(optional)</span></p>
                  <p className="text-xs text-muted-foreground mt-0.5">Personal email detected — providing GST or PAN helps verify your identity for invoicing purposes.</p>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {taxIdType === 'gst' ? '15-character GST number.' : '10-character PAN.'}
                  </p>
                </div>
              </div>
            )}
