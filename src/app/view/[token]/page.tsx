...
export default function StakeholderViewPage() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.text('Lakshmi Balaji Realty  ·  lease.orsone.app  ·  Read-Only Stakeholder Copy', pageW / 2, pageH - 4, { align: 'center' });
  ...
  return (
    <div className="min-h-screen no-print-download" style={{background:'hsl(259 30% 96%)'}}>
      ...
      <div className="print-footer hidden">
        ...
        <span>ORS-ONE · Lakshmi Balaji Realty · lease.orsone.app</span>
      </div>
    </div>
  );
}
