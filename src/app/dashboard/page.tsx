  ...
  return (
    <div className="mt-6 space-y-4">
      <div className="p-4 rounded-none" style={{background:'hsl(259 44% 96%)',border:'1px solid hsl(259 44% 82%)'}}>
        ...
        <p className="text-xs mt-1" style={{color:'hsl(259 15% 55%)'}}>These jobs run automatically via Vercel cron (daily at 8am IST, RFQ nudge every 6hrs). You can trigger them manually here.</p>
      </div>
      {results && (
